...
public class ServiceResourceDTO implements Serializable {
    ...
    private static final long serialVersionUID = 7528360008819668132L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ServiceResourceDTO)) return false;

        ServiceResourceDTO that = (ServiceResourceDTO) o;
