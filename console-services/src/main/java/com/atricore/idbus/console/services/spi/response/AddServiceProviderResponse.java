...
public class AddServiceProviderResponse extends AbstractManagementResponse {

	private ServiceProvider serviceProvider;

    public AddServiceProviderResponse(){}

	public AddServiceProviderResponse(ServiceProvider sp) {
		serviceProvider = sp;
	}
