...
public class ListGroupsCommand extends IocSimpleCommand implements IResponder {

    public static const SUCCESS:String = "ListGroupsCommand.SUCCESS";
    public static const FAILURE:String = "ListGroupsCommand.FAILURE";
