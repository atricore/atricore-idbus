...
package com.atricore.idbus.console.modeling.diagram.view.resources.phpbb {
...
public class PhpBBResourceCreateMediator extends IocFormMediator {
    ...
    public function PhpBBResourceCreateMediator(name:String = null, viewComp:PhpBBResourceCreateForm = null) {
        super(name, viewComp);
    }
    ...
    override public function bindModel():void {
        ...
        var phpBBResource:PhpBBResource = new PhpBBResource();

        phpBBResource.name = view.executionEnvironmentName.text;
        phpBBResource.description = view.executionEnvironmentDescription.text;
        phpBBResource.type = ExecEnvType.valueOf(view.selectedHost.selectedItem.data);
        phpBBResource.installUri = view.homeDirectory.text;
        if (phpBBResource.type.name == ExecEnvType.REMOTE.name)
            phpBBResource.location = view.location.text;
    ...
    protected function get view():PhpBBResourceCreateForm
    {
        return viewComponent as PhpBBResourceCreateForm;
    }
