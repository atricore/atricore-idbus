...
public class OpenIDIdentityProviderRemoveCommand extends IocSimpleCommand {

    public static const SUCCESS : String = "OpenIDIdentityProviderRemoveCommand.SUCCESS";

    private var _projectProxy:ProjectProxy;

    public function OpenIDIdentityProviderRemoveCommand() {
    }
    ...
    override public function execute(notification:INotification):void {
        var identityProvider:OpenIDIdentityProvider = notification.getBody() as OpenIDIdentityProvider;
