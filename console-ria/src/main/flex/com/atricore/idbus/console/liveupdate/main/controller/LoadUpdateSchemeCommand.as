...
public class LoadUpdateSchemeCommand extends IocSimpleCommand implements IResponder {

    public static const SUCCESS:String = "LoadUpdateSchemeCommand.SUCCESS";
    public static const FAILURE:String = "LoadUpdateSchemeCommand.FAILURE";
    ...
    override public function execute(notification:INotification):void {
        ...
        var call:Object = service.loadUpdateNotificationScheme(req);
        call.addResponder(this);
    }

    public function result(data:Object):void {
        var resp:UpdateNotificationSchemeResponse= data.result as UpdateNotificationSchemeResponse;
        liveUpdateProxy.notificationScheme = resp.notificationScheme;
