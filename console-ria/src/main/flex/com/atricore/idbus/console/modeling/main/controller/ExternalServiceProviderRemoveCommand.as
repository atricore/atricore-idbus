...
public class ExternalServiceProviderRemoveCommand extends IocSimpleCommand {

    public static const SUCCESS : String = "ExternalServiceProviderRemoveCommand.SUCCESS";

    private var _projectProxy:ProjectProxy;


    public function ExternalServiceProviderRemoveCommand() {
    }
    ...
    override public function execute(notification:INotification):void {
        var serviceProvider:ExternalServiceProvider = notification.getBody() as ExternalServiceProvider;
