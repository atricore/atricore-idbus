...
package com.atricore.idbus.console.modeling.diagram.view.executionenvironment.coldfusion {
...
public class ColdfusionExecutionEnvironmentCreateMediator extends IocFormMediator {
    ...
    private var _newExecutionEnvironment:ColdfusionExecutionEnvironment;

    private var _locationValidator:Validator;
    
    public function ColdfusionExecutionEnvironmentCreateMediator(name:String = null, viewComp:ColdfusionExecutionEnvironmentCreateForm = null) {
        super(name, viewComp);
    }
    ...
    override public function setViewComponent(viewComponent:Object):void {
        if (getViewComponent() != null) {
            view.btnOk.removeEventListener(MouseEvent.CLICK, handleColdfusionExecutionEnvironmentSave);
    ...
    private function init():void {
        ...
        view.btnOk.addEventListener(MouseEvent.CLICK, handleColdfusionExecutionEnvironmentSave);
    ...
    override public function bindModel():void {
        var executionEnvironment:ColdfusionExecutionEnvironment = new ColdfusionExecutionEnvironment();
        ...
        executionEnvironment.platformId = "coldfusion";
        _newExecutionEnvironment = executionEnvironment;
    }

    private function handleColdfusionExecutionEnvironmentSave(event:MouseEvent):void {
        view.homeDirectory.errorString = "";
        view.location.errorString = "";
        if (validate(true)) {
    ...
    protected function get view():ColdfusionExecutionEnvironmentCreateForm {
        return viewComponent as ColdfusionExecutionEnvironmentCreateForm;
    }
