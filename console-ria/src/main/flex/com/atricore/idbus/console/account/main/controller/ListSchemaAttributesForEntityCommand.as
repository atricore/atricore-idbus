...
public class ListSchemaAttributesForEntityCommand extends IocSimpleCommand implements IResponder {

    public static const SUCCESS:String = "ListSchemaAttributesForEntityCommand.SUCCESS";
    public static const FAILURE:String = "ListSchemaAttributesForEntityCommand.FAILURE";

    private var _registry:ServiceRegistry;
    private var _accountManagementProxy:AccountManagementProxy;


    public function ListSchemaAttributesForEntityCommand() {
    }
