...
public class Saml2IdentityProviderCreateMediator extends IocFormMediator {
    ...
    public function Saml2IdentityProviderCreateMediator(name:String = null, viewComp:Saml2IdentityProviderCreateForm = null) {
        super(name, viewComp);
    }
    ...
    protected function get view():Saml2IdentityProviderCreateForm {
        return viewComponent as Saml2IdentityProviderCreateForm;
    }
