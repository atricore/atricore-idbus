...
public class ApplyUpdateCommand extends IocSimpleCommand implements IResponder {

    public static const SUCCESS:String = "ApplyUpdateCommand.SUCCESS";
    public static const FAILURE:String = "ApplyUpdateCommand.FAILURE";
    ...
    override public function execute(notification:INotification):void {
        ...
        var applyUpdateRequest:ApplyUpdateRequest = notification.getBody() as ApplyUpdateRequest;
        var call:Object = service.applyUpdate(applyUpdateRequest);
        call.addResponder(this);
    }

    public function result(data:Object):void {
        var resp:ApplyUpdatesResponse = data.result as ApplyUpdatesResponse;
