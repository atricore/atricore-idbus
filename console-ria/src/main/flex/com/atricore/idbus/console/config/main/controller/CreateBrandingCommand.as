...
public class CreateBrandingCommand extends IocSimpleCommand implements IResponder
{
    public static const SUCCESS:String = "CreateBrandingCommand.SUCCESS";
    public static const FAILURE:String = "CreateBrandingCommand.FAILURE";

    private var _registry:ServiceRegistry;
    private var _configProxy:ServiceConfigProxy;

    public function CreateBrandingCommand() {
    }
    ...
    override public function execute(notification:INotification):void {
        var brandingDefinition:BrandingDefinition = notification.getBody() as BrandingDefinition;
        var service:RemoteObject = registry.getRemoteObjectService(ApplicationFacade.BRAND_MANAGEMENT_SERVICE);
        var call:Object = service.create(brandingDefinition);
