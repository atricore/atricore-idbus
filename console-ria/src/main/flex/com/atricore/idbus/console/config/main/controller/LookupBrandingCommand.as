...
public class LookupBrandingCommand extends IocSimpleCommand implements IResponder
{
    public static const SUCCESS:String = "LookupBrandingCommand.SUCCESS";
    public static const FAILURE:String = "LookupBrandingCommand.FAILURE";

    private var _registry:ServiceRegistry;
    private var _configProxy:ServiceConfigProxy;

    public function LookupBrandingCommand() {
    }
    ...
    override public function execute(notification:INotification):void {
        ...
        var call:Object = service.lookup(id);
        call.addResponder(this);
    }

    public function result(data:Object):void {
        _configProxy.brandingDefinition = data.result as BrandingDefinition;
