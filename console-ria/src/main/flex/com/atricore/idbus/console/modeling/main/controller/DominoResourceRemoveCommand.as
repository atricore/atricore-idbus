...
public class DominoResourceRemoveCommand extends IocSimpleCommand {

    public static const SUCCESS : String = "DominoResourceRemoveCommand.SUCCESS";

    private var _projectProxy:ProjectProxy;

    public function DominoResourceRemoveCommand() {
    }
    ...
    override public function execute(notification:INotification):void {
        var dominoResource:DominoResource = notification.getBody() as DominoResource;
