...
import com.atricore.idbus.console.services.spi.response.AddUserResponse;
...
public class AddUserCommand extends IocSimpleCommand implements IResponder {

    public static const SUCCESS:String = "AddUserCommand.SUCCESS";
    public static const FAILURE:String = "AddUserCommand.FAILURE";
    ...
    override public function execute(notification:INotification):void {
        ...
        var req:AddUserRequest = new AddUserRequest();
        ...
        var call:Object = service.addUser(req);
        call.addResponder(this);
    }

    public function result(data:Object):void {
        var resp:AddUserResponse = data.result as AddUserResponse;
        accountManagementProxy.currentUser = resp.user;
