...
public class DisposeIdentityApplianceCommand extends IocSimpleCommand implements IResponder
{
    public static const SUCCESS:String = "DisposeIdentityApplianceCommand.SUCCESS";
    public static const FAILURE:String = "DisposeIdentityApplianceCommand.FAILURE";
    ...
    override public function execute(notification:INotification):void {
        ...
        var req:DisposeIdentityApplianceRequest = new DisposeIdentityApplianceRequest();
        req.id = applianceId;
        var call:Object = service.disposeIdentityAppliance(req);
        call.addResponder(this);
    }

    public function result(data:Object):void {
        var resp:DisposeIdentityApplianceResponse = data.result as DisposeIdentityApplianceResponse;
