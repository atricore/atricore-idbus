...
public class ExternalWSFederationServiceProviderRemoveCommand extends IocSimpleCommand {

    public static const SUCCESS : String = "ExternalWSFederationServiceProviderRemoveCommand.SUCCESS";

    private var _projectProxy:ProjectProxy;

    public function ExternalWSFederationServiceProviderRemoveCommand() {
    }
    ...
    override public function execute(notification:INotification):void {
        var serviceProvider:ExternalWSFederationServiceProvider = notification.getBody() as ExternalWSFederationServiceProvider;
