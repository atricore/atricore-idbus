...
public class OAuth2IdentityProviderRemoveCommand extends IocSimpleCommand {

    public static const SUCCESS : String = "OAuth2IdentityProviderRemoveCommand.SUCCESS";

    private var _projectProxy:ProjectProxy;

    public function OAuth2IdentityProviderRemoveCommand() {
    }
    ...
    override public function execute(notification:INotification):void {
        var identityProvider:OAuth2IdentityProvider = notification.getBody() as OAuth2IdentityProvider;
