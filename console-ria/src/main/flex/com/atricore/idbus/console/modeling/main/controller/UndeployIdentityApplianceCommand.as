...
public class UndeployIdentityApplianceCommand extends IocSimpleCommand implements IResponder
{
    public static const SUCCESS:String = "UndeployIdentityApplianceCommand.SUCCESS";
    public static const FAILURE:String = "UndeployIdentityApplianceCommand.FAILURE";
    ...
    override public function execute(notification:INotification):void {
        ...
        var req:UndeployIdentityApplianceRequest = new UndeployIdentityApplianceRequest();
        req.applianceId = applianceId;
        var call:Object = service.undeployIdentityAppliance(req);
