...
package com.atricore.idbus.console.modeling.diagram.view.resources.jbossportal {
...
public class JBossPortalResourceCreateMediator extends IocFormMediator {
    ...
    public function JBossPortalResourceCreateMediator(name:String = null, viewComp:JBossPortalResourceCreateForm = null) {
        super(name, viewComp);
    }
    ...
    override public function setViewComponent(viewComponent:Object):void {
        if (getViewComponent() != null) {
            view.btnOk.removeEventListener(MouseEvent.CLICK, handleJBossPortalResourceSave);
    ...
    private function init():void {
        ...
        view.btnOk.addEventListener(MouseEvent.CLICK, handleJBossPortalResourceSave);
    ...
    override public function bindModel():void {
        var resource:JBossPortalResource = new JBossPortalResource();
        resource.name = view.executionEnvironmentName.text;
        resource.description = view.executionEnvironmentDescription.text;
    ...
    protected function get view():JBossPortalResourceCreateForm {
        return viewComponent as JBossPortalResourceCreateForm;
    }
