...
public class SaveUpdateSchemeCommand extends IocSimpleCommand implements IResponder {

    public static const SUCCESS:String = "SaveUpdateSchemeCommand.SUCCESS";
    public static const FAILURE:String = "SaveUpdateSchemeCommand.FAILURE";

    private var _registry:ServiceRegistry;
    private var _liveUpdateProxy:LiveUpdateProxy;

    public function SaveUpdateSchemeCommand() {
    }
