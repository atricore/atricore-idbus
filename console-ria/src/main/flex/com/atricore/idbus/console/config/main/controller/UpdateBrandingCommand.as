...
public class UpdateBrandingCommand extends IocSimpleCommand implements IResponder
{
    public static const SUCCESS:String = "UpdateBrandingCommand.SUCCESS";
    public static const FAILURE:String = "UpdateBrandingCommand.FAILURE";

    private var _registry:ServiceRegistry;
    private var _configProxy:ServiceConfigProxy;

    public function UpdateBrandingCommand() {
    }
    ...
    override public function execute(notification:INotification):void {
        ...
        var call:Object = service.update(brandingDefinition);
