...
public class SetupWizardViewMediator extends Mediator
{
    public static const NAME:String = "SetupWizardViewMediator";
    ...
    public function SetupWizardViewMediator(viewComp:SetupWizardView) {
        super(NAME, viewComp);
    ...
    private function onServerSetupWizardComplete(event:WizardEvent):void {
        ...
        sendNotification(ApplicationFacade.NOTE_SETUP_SERVER);
    }
