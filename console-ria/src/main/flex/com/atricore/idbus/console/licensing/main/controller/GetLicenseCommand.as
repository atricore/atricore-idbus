...
public class GetLicenseCommand extends IocSimpleCommand implements IResponder
{
    public static const SUCCESS:String = "com.atricore.idbus.console.licensing.main.controller.GetLicenseCommand.SUCCESS";
    public static const FAILURE:String = "com.atricore.idbus.console.licensing.main.controller.GetLicenseCommand.FAILURE";

    private var _registry:ServiceRegistry;
    private var _licenseProxy:LicenseProxy;

    public function GetLicenseCommand() {
    }
