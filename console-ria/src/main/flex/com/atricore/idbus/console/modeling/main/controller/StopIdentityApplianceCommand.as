...
public class StopIdentityApplianceCommand extends IocSimpleCommand implements IResponder
{
    public static const SUCCESS:String = "StopIdentityApplianceCommand.SUCCESS";
    public static const FAILURE:String = "StopIdentityApplianceCommand.FAILURE";
    ...
    override public function execute(notification:INotification):void {
        ...
        var req:StopIdentityApplianceRequest = new StopIdentityApplianceRequest();
        req.id = applianceId;
        var call:Object = service.stopIdentityAppliance(req);
