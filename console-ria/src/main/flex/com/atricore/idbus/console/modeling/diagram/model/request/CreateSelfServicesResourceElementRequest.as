...
public class CreateSelfServicesResourceElementRequest {

    private var _identityAppliance:IdentityAppliance;
    private var _notationalElementId:String;

    public function CreateSelfServicesResourceElementRequest(identityAppliance:IdentityAppliance, notationalElementId:String) {
