...
public class EditAttributeCommand extends IocSimpleCommand implements IResponder {

    public static const SUCCESS:String = "EditAttributeCommand.SUCCESS";
    public static const FAILURE:String = "EditAttributeCommand.FAILURE";

    private var _registry:ServiceRegistry;

    public function EditAttributeCommand() {
    }
    ...
    override public function execute(notification:INotification):void {
        ...
        var req:UpdateSchemaAttributeRequest = new UpdateSchemaAttributeRequest();
        req.attribute = atr;
        var call:Object = service.updateSchemaAttribute(req);
        call.addResponder(this);
    }

    public function result(data:Object):void {
        var resp:UpdateSchemaAttributeResponse = data.result as UpdateSchemaAttributeResponse;
