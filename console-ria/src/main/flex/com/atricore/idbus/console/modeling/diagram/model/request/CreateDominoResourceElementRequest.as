...
public class CreateDominoResourceElementRequest {

    private var _identityAppliance:IdentityAppliance;
    private var _notationalElementId:String;

    public function CreateDominoResourceElementRequest(identityAppliance:IdentityAppliance, notationalElementId:String) {
