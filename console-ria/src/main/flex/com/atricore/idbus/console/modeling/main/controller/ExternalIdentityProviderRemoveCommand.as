...
public class ExternalIdentityProviderRemoveCommand extends IocSimpleCommand {

    public static const SUCCESS : String = "ExternalIdentityProviderRemoveCommand.SUCCESS";

    private var _projectProxy:ProjectProxy;


    public function ExternalIdentityProviderRemoveCommand() {
    }
    ...
    override public function execute(notification:INotification):void {
        var identityProvider:ExternalIdentityProvider = notification.getBody() as ExternalIdentityProvider;
