...
public class InternalSaml2ServiceProviderRemoveCommand extends IocSimpleCommand {

    public static const SUCCESS : String = "InternalSaml2ServiceProviderRemoveCommand.SUCCESS";

    private var _projectProxy:ProjectProxy;

    public function InternalSaml2ServiceProviderRemoveCommand() {
    ...
    override public function execute(notification:INotification):void {
        var serviceProvider:InternalSaml2ServiceProvider = notification.getBody() as InternalSaml2ServiceProvider;
