...
public class StartIdentityApplianceCommand extends IocSimpleCommand implements IResponder
{
    public static const SUCCESS:String = "StartIdentityApplianceCommand.SUCCESS";
    public static const FAILURE:String = "StartIdentityApplianceCommand.FAILURE";
    ...
    override public function execute(notification:INotification):void {
        ...
        var req:StartIdentityApplianceRequest = new StartIdentityApplianceRequest();
        req.id = applianceId;
        var call:Object = service.startIdentityAppliance(req);
        call.addResponder(this);
    }

    public function result(data:Object):void {
        var resp:StartIdentityApplianceResponse = data.result as StartIdentityApplianceResponse;
