...
import com.atricore.idbus.console.services.spi.response.CheckForUpdatesResponse;
...
public class CheckForUpdatesCommand extends IocSimpleCommand implements IResponder {

    public static const SUCCESS:String = "CheckForUpdatesCommand.SUCCESS";
    public static const FAILURE:String = "CheckForUpdatesCommand.FAILURE";
    ...
    override public function execute(notification:INotification):void {
        ...
        var call:Object = service.checkForUpdates();
        call.addResponder(this);
    }

    public function result(data:Object):void {
        var resp:CheckForUpdatesResponse = data.result as CheckForUpdatesResponse;
