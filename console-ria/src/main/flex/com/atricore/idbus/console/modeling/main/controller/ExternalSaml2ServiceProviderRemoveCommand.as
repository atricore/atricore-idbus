...
public class ExternalSaml2ServiceProviderRemoveCommand extends IocSimpleCommand {

    public static const SUCCESS : String = "ExternalSaml2ServiceProviderRemoveCommand.SUCCESS";

    private var _projectProxy:ProjectProxy;

    public function ExternalSaml2ServiceProviderRemoveCommand() {
    }
    ...
    override public function execute(notification:INotification):void {
        var serviceProvider:ExternalSaml2ServiceProvider = notification.getBody() as ExternalSaml2ServiceProvider;
