...
public class ListBrandingsCommand extends IocSimpleCommand implements IResponder
{
    public static const SUCCESS:String = "ListBrandingsCommand.SUCCESS";
    public static const FAILURE:String = "ListBrandingsCommand.FAILURE";

    private var _registry:ServiceRegistry;
    private var _configProxy:ServiceConfigProxy;

    public function ListBrandingsCommand() {
    }
    ...
    override public function execute(notification:INotification):void {
        ...
        var call:Object = service.list();
        call.addResponder(this);
    }

    public function result(data:Object):void {
        _configProxy.brandingDefinitions = data.result as ArrayCollection;
