...
public class DeleteAttributeCommand extends IocSimpleCommand implements IResponder {

    public static const SUCCESS:String = "DeleteAttributeCommand.SUCCESS";
    public static const FAILURE:String = "DeleteAttributeCommand.FAILURE";

    private var _registry:ServiceRegistry;

    public function DeleteAttributeCommand() {
    }
    ...
    public function result(data:Object):void {
        var resp:RemoveSchemaAttributeResponse = data.result as RemoveSchemaAttributeResponse;
