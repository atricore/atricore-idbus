...
public class ExportProviderCertificateCommand extends IocSimpleCommand implements IResponder {

    public static const SUCCESS:String = "ExportProviderCertificateCommand.SUCCESS";
    public static const FAILURE:String = "ExportProviderCertificateCommand.FAILURE";
    ...
    override public function execute(notification:INotification):void {
        ...
        var req:ExportProviderCertificateRequest = new ExportProviderCertificateRequest();
        req.config = config;
        var call:Object = service.exportProviderCertificate(req);
        call.addResponder(this);
    }

    public function result(data:Object):void {
        var resp:ExportProviderCertificateResponse = data.result as ExportProviderCertificateResponse;
