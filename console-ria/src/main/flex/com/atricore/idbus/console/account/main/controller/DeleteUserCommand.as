...
import com.atricore.idbus.console.services.spi.response.RemoveUserResponse;
...
public class DeleteUserCommand extends IocSimpleCommand implements IResponder {

    public static const SUCCESS:String = "DeleteUserCommand.SUCCESS";
    public static const FAILURE:String = "DeleteUserCommand.FAILURE";
    ...
    public function result(data:Object):void {
        var resp:RemoveUserResponse = data.result as RemoveUserResponse;
