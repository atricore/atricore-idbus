...
public class SearchUsersCommand extends IocSimpleCommand implements IResponder {

    public static const SUCCESS:String = "SearchUsersCommand.as.SUCCESS";
    public static const FAILURE:String = "SearchUsersCommand.as.FAILURE";
    ...
    public function result(data:Object):void {
        var resp:SearchUserResponse = data.result as SearchUserResponse;
        accountManagementProxy.searchedUsers = resp.users;
