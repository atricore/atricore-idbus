...
public class RemoveBrandingCommand extends IocSimpleCommand implements IResponder
{
    public static const SUCCESS:String = "RemoveBrandingCommand.SUCCESS";
    public static const FAILURE:String = "RemoveBrandingCommand.FAILURE";

    private var _registry:ServiceRegistry;
    private var _configProxy:ServiceConfigProxy;

    public function RemoveBrandingCommand() {
    }
    ...
    override public function execute(notification:INotification):void {
        ...
        var call:Object = service.remove(id);
