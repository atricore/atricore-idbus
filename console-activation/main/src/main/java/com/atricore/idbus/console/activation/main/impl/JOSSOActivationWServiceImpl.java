...
import com.atricore.idbus.console.appliance.jaas.JaasAuthenticator;
...
public class JOSSOActivationWServiceImpl implements ActivationPortType {
    ...
    public ConfigureAgentResponseType configureAgent(ConfigureAgentRequestType wsRequest) {
        ...
        try {
            ...
            authenticate(wsRequest.getUser(), wsRequest.getPassword());
    ...
    protected Subject authenticate(String username, String password) {
        ...
        if (!enableAuthentication) {
            if (logger.isTraceEnabled())
                logger.trace("Authentication disabled");
    ...
    public JaasAuthenticator getAuthenticator() {
        return authenticator;
    }

    public void setAuthenticator(JaasAuthenticator authenticator) {
