...
<html>
	<head>
        ...
        <script type="text/javascript">
            ...
            swfobject.embedSWF("<%=request.getContextPath()%>/console-ria-1.1.1-SNAPSHOT.swf", "flashcontent", "100%", "100%", "10.0.0", "<%=request.getContextPath()%>/js/swf/expressInstall.swf", flashvars, params, attributes);
