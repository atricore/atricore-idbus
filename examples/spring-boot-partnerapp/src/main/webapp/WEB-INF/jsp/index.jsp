...
<%@ page import="org.josso.spring.security.JOSSOAuthenticationToken" %>
...
<head>
    ...
    <link href="<%=request.getContextPath()%>/css/screen.css" rel="stylesheet" type="text/css" media="screen, projector"/>

    <!--[if IE 6]><link href="<%=request.getContextPath()%>/css/ie6.css" rel="stylesheet" type="text/css" media="screen, projector" /><![endif]-->
    <!--[if IE 7]><link href="<%=request.getContextPath()%>/css/ie7.css" rel="stylesheet" type="text/css" media="screen, projector" /><![endif]-->
      ...
      <div id="header">
            ...
            <h1> <!-- Logo JOSSO-->
                  <a href="http://www.josso.org" title="Click here to go to the homepage">
                        <img src="<%=request.getContextPath()%>/img/content/josso-logo.png" alt="Java Open Single SignOn" width="372" height="48" />
                  </a>
            </h1> <!-- /Logo JOSSO -->

            <h2> <!-- Logo Atricore -->
                  <a href="http://www.atricore.com">
                        <img src="<%=request.getContextPath()%>/img/content/atricore-logo.gif" alt="Atricore, the company behind JOSSO" width="254" height="66" />
                  </a>
            </h2> <!-- /Logo Atricore -->
                  ...
                  <div class="main">
                        ...
                        <div id="col2">
                            ...
                            <div id="col3">
                                ...
                                <ul>
                                    <li>Retrieved from [<code>WebAccessControlUtil.getSecurityContext(request).getCurrentPrincipal().getProperties();</code>]</li>

                                    <%
                                        JOSSOSecurityContext ctx = WebAccessControlUtil.getSecurityContext(request);
                                        SSOUser ssoUser = ctx.getCurrentPrincipal();
                            ...
                            <div id="col3">
                                <h3 class="arrow">Authentication object holds the following granted authorities (SecurityContextHolder.getContext().getAuthentication().getAuthorities()):</h3>
                                <%
