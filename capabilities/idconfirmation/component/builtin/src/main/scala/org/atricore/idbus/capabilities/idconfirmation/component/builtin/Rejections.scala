...
/**
 * Predefined rejection constants for identity confirmation directives
 *
 * @author <a href="mailto:gbrigandi@atricore.org">Gianluca Brigandi</a>
 */
object Rejections {

  case object NoIdentityConfirmationRequestAvailable extends Rejection
  case object NoClaimFound extends Rejection
  case object IdentityConfirmationNotRequired extends Rejection
  case object NoIdentityConfirmationTokenAuthenticationRequestAvailable extends Rejection
