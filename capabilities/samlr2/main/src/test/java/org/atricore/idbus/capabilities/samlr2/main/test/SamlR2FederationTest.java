 ...
 * @version $Id: SamlR2FederationTest.java 1337 2009-06-25 13:18:38Z sgonzalez $
 */
public class SamlR2FederationTest {

    private static final Log logger = LogFactory.getLog(SamlR2FederationTest.class);
    ...
    public void setup() throws Exception {
        applicationContext = new ClassPathXmlApplicationContext(
                new String[]{"/org/atricore/idbus/capabilities/samlr2/main/test/josso2-samlr2-federation-test.xml"}
        );
    ...
    public void testUnsolicitedResponse() throws Exception{
        ...
        String sp1AcsUrl = "http://localhost:8181/IDBUS/SP-1/SAML2/ACS/POST";
