 ...
 * @version $Id$
 */
public class AssertIdentityWithSimpleAuthenticationReqToSamlR2AuthnReqPlan extends AbstractJbpmIdentityPlan {

    protected String getProcessDescriptorName() {
        return "spsso-assertidwithsimplauthreq-to-samlr2authnreq";
    }
}