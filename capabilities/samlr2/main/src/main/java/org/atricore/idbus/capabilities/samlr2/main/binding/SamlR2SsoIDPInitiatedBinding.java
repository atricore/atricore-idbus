 ...
 * @version $Id$
 */
public class SamlR2SsoIDPInitiatedBinding extends AbstractMediationHttpBinding {

    private static final Log logger = LogFactory.getLog(SamlR2SsoIDPInitiatedBinding.class);

    private UUIDGenerator uuidGenerator = new UUIDGenerator();

    public SamlR2SsoIDPInitiatedBinding(Channel channel) {
        super(SamlR2Binding.SSO_IDP_INITIATED_SSO_HTTP_SAML2.getValue(), channel);
    }
