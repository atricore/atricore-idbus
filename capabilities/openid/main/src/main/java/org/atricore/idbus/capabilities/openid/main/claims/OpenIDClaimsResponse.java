 ...
 * @version $Id$
 */
public class OpenIDClaimsResponse extends ClaimsResponseImpl {

    public OpenIDClaimsResponse(String id, Channel issuer, String inResponseTo, ClaimSet claimSet, String relayState) {
