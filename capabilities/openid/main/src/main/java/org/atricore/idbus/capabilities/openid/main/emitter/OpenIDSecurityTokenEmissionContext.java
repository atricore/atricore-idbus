 ...
 * @version $Id$
 */
public class OpenIDSecurityTokenEmissionContext implements Serializable {
    ...
    public OpenIDSecurityTokenEmissionContext() {
    }

    public OpenIDSecurityTokenEmissionContext(CircleOfTrustMemberDescriptor member,
