...
import org.atricore.idbus.capabilities.openid.main.support.AuthnCtxClass;
...
public class OpenIDClaimsComponent extends DefaultComponent {
    ...
    private static final Log logger = LogFactory.getLog( org.atricore.idbus.capabilities.openid.main.claims.OpenIDClaimsComponent.class );
    ...
    protected Endpoint createEndpoint(String uri, String remaining, Map parameters) throws Exception {
        ...
        switch(authnCtx) {
            case PASSWORD_AUTHN_CTX:
                ...
                break;
            default:
                throw new OpenIDException("Unsupported endpoint type " + remaining);
