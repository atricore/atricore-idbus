 ...
 * @version $Id$
 */
public class OpenIDClaimsRequest extends ClaimsRequestImpl {

    private RequestedAuthnContextType requestedAuthnCtxClass;

    public OpenIDClaimsRequest(String id, Channel issuer, IdentityMediationEndpoint endpoint, ClaimChannel provider, String relayState) {
