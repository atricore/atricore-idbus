 ...
 * @version $Id: OpenIDClaimsMediator.java 1359 2009-07-19 16:57:57Z gbrigand $
 */
public class OpenIDClaimsMediator extends AbstractOpenIDMediator {

    private static final Log logger = LogFactory.getLog( org.atricore.idbus.capabilities.openid.main.claims.OpenIDClaimsMediator.class );
