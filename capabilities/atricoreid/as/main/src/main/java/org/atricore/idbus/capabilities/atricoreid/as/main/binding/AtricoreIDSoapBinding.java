...
import org.atricore.idbus.capabilities.atricoreid.common.AtricoreIDMessagingConstants;
 ...
 */
public class AtricoreIDSoapBinding extends AbstractMediationSoapBinding {

    private static final Log logger = LogFactory.getLog(AtricoreIDSoapBinding.class);

    public AtricoreIDSoapBinding(Channel channel) {
        super(AtricoreIDBinding.OAUTH2_SOAP.getValue(), channel);
    }
    ...
    public MediationMessage createMessage(CamelMediationMessage message) {
        ...
        if (in.getBody() instanceof MessageContentsList) {
            ...
            if (mclIn.get(0) instanceof AtricoreIDRequestAbstractType) {

                // Process Saml Request in SOAP Channel

                // Try to restore provider state based on sessionIndex

                AtricoreIDRequestAbstractType oauthRequestAbstracType = (AtricoreIDRequestAbstractType) mclIn.get(0);
    ...
    public Object sendMessage(MediationMessage message) throws IdentityMediationException {
        ...
        Service service = Service.create(AtricoreIDMessagingConstants.SERVICE_NAME);
        service.addPort(AtricoreIDMessagingConstants.PORT_NAME,
        ...
        AtricoreIDPortType port = service.getPort(AtricoreIDMessagingConstants.PORT_NAME, AtricoreIDPortType.class);
