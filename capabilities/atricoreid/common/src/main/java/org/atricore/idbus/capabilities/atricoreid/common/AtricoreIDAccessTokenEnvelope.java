 ...
 */
public class AtricoreIDAccessTokenEnvelope {
    ...
    public AtricoreIDAccessTokenEnvelope(String encryptionAlg, String signatureAlg, String signatureValue, String token, boolean deflated) {
    ...
    public AtricoreIDAccessTokenEnvelope() {
    }
