...
/**
 * OAuth2 Claim Mediator
 *
 * @author <a href=mailto:gbrigandi@atricore.org>Gianluca Brigandi</a>
 */
public class OAuth2ClaimsMediator extends AbstractCamelMediator {

    private static final Log logger = LogFactory.getLog(OAuth2ClaimsMediator.class);


    public OAuth2ClaimsMediator() {
        logger.info("OAuth2ClaimsMediator Instantiated");
    }
