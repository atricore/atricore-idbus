...
public class XmlUtilsTest {
    ...
    public void testValidID() throws Exception {
        XmlUtils.verifyID("id49CD3EFC3C7970");
        XmlUtils.verifyID("id-148ba-a34820-a0834-342ac");
        XmlUtils.verifyID("id_123456");
    }

    @Test(expected = InvalidXMLException.class)
    public void testInvalidIDXpath1() throws Exception {
        XmlUtils.verifyID("/xxx");
    }


    @Test(expected = InvalidXMLException.class)
    public void testInvalidIDXpath2() throws Exception {
        XmlUtils.verifyID("/employees/employee[contains(@id,'1')]/firstName/text()");
    }

    @Test(expected = InvalidXMLException.class)
    public void testInvalidIDXpath3() throws Exception {
        XmlUtils.verifyID("descendant-or-self::*[contains(@id,'1')]/firstName/text()");
    }
