 ...
 * @date: 4/16/13
 */
public class VerifySecQuestionsPanel extends Panel {
    ...
    private VerifySecQuestionsModel model;

    public VerifySecQuestionsPanel(String id, User user, String hashAlgorithm, String hashEncoding) {
        this(id, user);
        this.hashAlgorithm = hashAlgorithm;
        this.hashEncoding = hashEncoding;
    }

    public VerifySecQuestionsPanel(String id, User user) {
        super(id);
        this.user = user;
        ...
        // Build the FORM
        model = new VerifySecQuestionsModel();

        form = new StatelessForm<VerifySecQuestionsModel>("verifyPwdResetForm", new CompoundPropertyModel<VerifySecQuestionsModel>(model));
