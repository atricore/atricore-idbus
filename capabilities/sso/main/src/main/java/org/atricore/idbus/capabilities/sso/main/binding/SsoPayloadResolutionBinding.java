...
public class SsoPayloadResolutionBinding extends AbstractMediationHttpBinding {

    private static final Log logger = LogFactory.getLog(SsoPayloadResolutionBinding.class);

    public static final String SSO_PAYLOAD = "uuid";

    public SsoPayloadResolutionBinding(Channel channel) {
