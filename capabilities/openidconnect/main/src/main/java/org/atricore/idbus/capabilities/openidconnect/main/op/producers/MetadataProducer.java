...

  {
   ...
   "ui_locales_supported":
    ...
    protected void doProcess(CamelMediationExchange exchange) throws Exception {
        ...
        // TODO : create request (OIDC JDK does not have one ? .. )

        OpenIDConnectOPMediator mediator = (OpenIDConnectOPMediator) channel.getIdentityMediator();
        // Metadata associated to the OP
        OIDCProviderMetadata metadata = null; /// TODO : mediator should have MD mediator.getMetadata();

        String jsonMetadata = metadata.toJSONObject().toJSONString();
