...
public class ExtOpSubjectMapper extends BaseSubjectMapper {

    public ExtOpSubjectMapper(FederatedProvider provider, OIDCTokens tokens) {
    ...
    public static class ExtOpSubjectMapperFactory implements OpenIdSubjectMapperFactory {
        @Override
