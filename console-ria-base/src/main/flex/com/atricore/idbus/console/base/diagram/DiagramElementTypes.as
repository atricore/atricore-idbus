...
public class DiagramElementTypes {
    ...
    public static const ACTIVATION_ELEMENT_TYPE:int = 7;
    public static const IDENTITY_LOOKUP_ELEMENT_TYPE:int = 8;
    public static const ALFRESCO_RESOURCE_ELEMENT_TYPE:int = 9;
    public static const APACHE_EXECUTION_ENVIRONMENT_ELEMENT_TYPE:int = 10;
    public static const JAVAEE_EXECUTION_ENVIRONMENT_ELEMENT_TYPE:int = 11;
    public static const JBOSS_EXECUTION_ENVIRONMENT_ELEMENT_TYPE:int = 12;
    public static const LIFERAY_RESOURCE_ELEMENT_TYPE:int = 13;
    public static const PHPBB_RESOURCE_ELEMENT_TYPE:int = 14;
    public static const TOMCAT_EXECUTION_ENVIRONMENT_ELEMENT_TYPE:int = 15;
    public static const WEBSERVER_EXECUTION_ENVIRONMENT_ELEMENT_TYPE:int = 16;
    public static const WEBLOGIC_EXECUTION_ENVIRONMENT_ELEMENT_TYPE:int = 17;
    ...
    public static const EXECUTION_ENVIRONMENT_ELEMENT_TYPE:int = 24;
    public static const SALESFORCE_ELEMENT_TYPE:int = 25;
    public static const GOOGLE_APPS_ELEMENT_TYPE:int = 26;
    public static const PHP_EXECUTION_ENVIRONMENT_ELEMENT_TYPE:int = 27;
    public static const SUGAR_CRM_ELEMENT_TYPE:int = 28;
    public static const WIKID_ELEMENT_TYPE:int = 29;
