...
package org.atricore.idbus.capabilities.management.support.springmetadata.impl;
...
import org.atricore.idbus.capabilities.management.support.springmetadata.exception.BeanNotFoundException;
import org.atricore.idbus.capabilities.management.support.springmetadata.exception.SpringMetadataManagementException;
import org.atricore.idbus.capabilities.management.support.springmetadata.model.osgi.*;
...
public class SpringMetadataManagerImpl implements SpringMetadataManager, DisposableBean, InitializingBean {
    ...
    private List<Object> collectObjectChildren(Object o){
    	...
    	} else if (o instanceof org.atricore.idbus.capabilities.management.support.springmetadata.model.List){
    		toDelete.addAll(collectListChildren((org.atricore.idbus.capabilities.management.support.springmetadata.model.List) o));
    	} else if (o instanceof org.atricore.idbus.capabilities.management.support.springmetadata.model.Set){
    		toDelete.addAll(collectSetChildren((Set) o));
    	} else if (o instanceof org.atricore.idbus.capabilities.management.support.springmetadata.model.Map){
	...
	private List<Object> collectListChildren(
			org.atricore.idbus.capabilities.management.support.springmetadata.model.List list) {
    	List<Object> toDelete = new ArrayList<Object>();
...
//                logger.debug("# of defined beans : " + ((Beans)obj).getAliasAndImportsAndBeen().size());
                ...
                jaxbContext = JAXBContext.newInstance("org.atricore.idbus.capabilities.management.support.springmetadata.model");
