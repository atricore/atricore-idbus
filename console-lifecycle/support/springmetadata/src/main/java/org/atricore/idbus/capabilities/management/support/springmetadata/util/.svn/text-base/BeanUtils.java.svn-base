...
package org.atricore.idbus.capabilities.management.support.springmetadata.util;
...
import org.atricore.idbus.capabilities.management.support.springmetadata.model.*;
...
public class BeanUtils {
    ...
    protected static void addRefToList(org.atricore.idbus.capabilities.management.support.springmetadata.model.List list, String refValue){
        Ref refObj = new Ref();
        refObj.setBean(refValue);
        list.getBeenAndRevesAndIdreves().add(refObj);
    }

    protected static void addBeanToList(org.atricore.idbus.capabilities.management.support.springmetadata.model.List list, Bean bean){
        list.getBeenAndRevesAndIdreves().add(bean);
    }

    protected static org.atricore.idbus.capabilities.management.support.springmetadata.model.List getListOfValuesAndRefs(Bean bean, String name){
    ...
    protected static org.atricore.idbus.capabilities.management.support.springmetadata.model.Set getSetOfValuesAndRefs(Bean bean, String name){
        Property prop = getProperty(bean, name);
    ...
    protected static void setRefsList(Bean bean, String listName, String[] references) {
        org.atricore.idbus.capabilities.management.support.springmetadata.model.List list = getListOfValuesAndRefs(bean, listName); //this could be null
    ...
    public static void setPropertyAsBeans(Bean bean, String listName, java.util.List<Bean> beansToAdd) {
        org.atricore.idbus.capabilities.management.support.springmetadata.model.List list = null;//getListOfValuesAndRefs(bean, listName);
        ...
        list = new org.atricore.idbus.capabilities.management.support.springmetadata.model.List();
        prop = new Property();
    ...
    public static void setPropertyAsRefs(Bean bean, String listName, java.util.List<Bean> beansToAdd){
        org.atricore.idbus.capabilities.management.support.springmetadata.model.List list = null;
        Property prop = getProperty(bean, listName);
...
//        list.getBeenAndRevesAndIdreves().clear();
    ...
    public static void setPropertyRefs(Bean bean, String setName, java.util.Set<Ref> refsToAdd){
        org.atricore.idbus.capabilities.management.support.springmetadata.model.Set set = null;
        Property prop = getProperty(bean, setName);

        if(prop != null){
            bean.getMetasAndConstructorArgsAndProperties().remove(prop);
        }
        set = new org.atricore.idbus.capabilities.management.support.springmetadata.model.Set();
        prop = new Property();
    ...
    public static void setPropertyAsMapEntries(Bean bean, String name, java.util.List<Entry> entriesToAdd){
        org.atricore.idbus.capabilities.management.support.springmetadata.model.Map map = null;
        Property prop = getProperty(bean, name);

        if(prop != null){
            bean.getMetasAndConstructorArgsAndProperties().remove(prop);
        }
        map = new org.atricore.idbus.capabilities.management.support.springmetadata.model.Map();
        prop = new Property();
        prop.setName(name);
    ...
    public static void setPropertyValue(Bean bean, String name, java.util.List<Prop> propsToAdd){
        org.atricore.idbus.capabilities.management.support.springmetadata.model.Props props = null;
        Property prop = getProperty(bean, name);

        if(prop != null){
            bean.getMetasAndConstructorArgsAndProperties().remove(prop);
        }
        props = new org.atricore.idbus.capabilities.management.support.springmetadata.model.Props();
        prop = new Property();
        prop.setName(name);
    ...
    public static java.util.List<Bean> getPropertyBeans(Bean bean, String propertyName) {
        org.atricore.idbus.capabilities.management.support.springmetadata.model.List list = getListOfValuesAndRefs(bean, propertyName);
    ...
    public static void addPropertyBeansAsRefs(Bean bean, String listName, Bean beanToAdd) {
        ...
        org.atricore.idbus.capabilities.management.support.springmetadata.model.List refList = getListOfValuesAndRefs(bean, listName);
        if(refList == null){
            refList = new org.atricore.idbus.capabilities.management.support.springmetadata.model.List();
        } else {
    ...
    public static void addPropertyBeansAsRefsToSet(Bean bean, String setName, Bean beanToAdd) {
        ...
        org.atricore.idbus.capabilities.management.support.springmetadata.model.Set refSet = getSetOfValuesAndRefs(bean, setName);
        if(refSet == null){
            refSet = new org.atricore.idbus.capabilities.management.support.springmetadata.model.Set();
        } else {
    ...
    public static void addPropertyBean(Bean bean, String listName, Bean beanToAdd) {
        ...
        org.atricore.idbus.capabilities.management.support.springmetadata.model.List beanList = getListOfValuesAndRefs(bean, listName);
        if(beanList == null){
            beanList = new org.atricore.idbus.capabilities.management.support.springmetadata.model.List();
        } else {
    ...
    public static String marshal(Beans beans, ClassLoader cl) throws JAXBException, XMLStreamException {
        ...
        JAXBContext ctx = JAXBContext.newInstance("org.atricore.idbus.capabilities.management.support.springmetadata.model:" +
                ...
                "org.atricore.idbus.capabilities.management.support.springmetadata.model.tool", cl);
