 ...
 * @version $Id$
 */
@Command(scope = "appliance", name = "stop", description = "Stop Identity Appliance")
public class StopApplianceCommand extends ManagementCommandSupport {
    ...
    protected Object doExecute(IdentityApplianceManagementService svc) throws Exception {
        ...
        req.setAction(IdentityApplianceLifeCycleAction.STOP);
