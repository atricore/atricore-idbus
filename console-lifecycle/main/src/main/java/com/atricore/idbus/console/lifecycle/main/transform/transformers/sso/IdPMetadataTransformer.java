 ...
 * @version $Id$
 */
public class IdPMetadataTransformer extends AbstractTransformer implements InitializingBean {

    private static final Log logger = LogFactory.getLog(IdPMetadataTransformer.class);
    ...
    private EntityDescriptorType generateSPChannelMetadata(IdentityProvider provider, ServiceProviderChannel spChannel) throws TransformException {
        ...
        */
        ...
        String spChannelLocation = resolveLocationUrl(provider, spChannel);
