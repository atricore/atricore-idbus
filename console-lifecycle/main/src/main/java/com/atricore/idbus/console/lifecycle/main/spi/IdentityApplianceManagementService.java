...
public interface IdentityApplianceManagementService {
    ...
    ListAvailableEmbeddedIdentityVaultsResponse listAvailableEmbeddedIdentityVaults(ListAvailableEmbeddedIdentityVaultsRequest req) throws IdentityServerException;
    ...
    ListIdentityMappingPoliciesResponse listIdentityMappingPolicies(ListIdentityMappingPoliciesRequest req) throws IdentityServerException;
