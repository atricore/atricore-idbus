 ...
 *
 * Create super class for all IDP Proxy scenarios: OAuth 2.0 IdP proxy, OpenID IdP proxy, SamlR2 IdP proxy.
...
public class SamlR2IdPProxyTransformer extends AbstractSPChannelTransformer implements InitializingBean {
    ...
    public void before(TransformEvent event) throws TransformException {
        ...
        descr.getContent().add(provider.getName() + " : IdP Proxy Configuration ("+provider.getName()+"/"+otherProvider.getName()+") generated by Atricore Identity Bus Server on " + now.toGMTString());
