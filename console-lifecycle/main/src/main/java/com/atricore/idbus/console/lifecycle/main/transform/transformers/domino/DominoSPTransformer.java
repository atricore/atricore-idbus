...
import com.atricore.idbus.console.lifecycle.main.domain.metadata.DominoResource;
...
public class DominoSPTransformer extends AbstractTransformer {

    private static final Log logger = LogFactory.getLog(DominoSPTransformer.class);
    ...
    public void before(TransformEvent event) throws TransformException {
        ...
        DominoResource dominoResource = (DominoResource) event.getData();
        InternalSaml2ServiceProvider sp = dominoResource.getServiceConnection().getSp();

        if (logger.isTraceEnabled())
            logger.trace("Generating Beans for Domino Resources " + dominoResource.getName()  + " of SP " + sp.getName());
        ...
        String bcName = normalizeBeanName(sp.getName() + "-" + dominoResource.getName() + "-domino-rsrc");
        ...
        setPropertyValue(bc, "description", "Domino Resource binding channel for " + sp.getName() + " :  " +
                dominoResource.getName() + "[appId:"+sp.getName()+"]");
