...
public class TransformerVisitor implements IdentityApplianceDefinitionVisitor {
     ...
     * @param node the node to be walked
     */
    public void arrive(ExternalServiceProvider node) {
        arrive(contextHolder.get(), node);
    }
     ...
     * @return the result of walking the node and it's children
     */
    public Object[] leave(ExternalServiceProvider node, Object[] results) {
        return leave(contextHolder.get(), node, results);
    }
     ...
     * @param node the node to be walked
     */
    public void arrive(ExternalIdentityProvider node) {
        arrive(contextHolder.get(), node);
    }
     ...
     * @return the result of walking the node and it's children
     */
    public Object[] leave(ExternalIdentityProvider node, Object[] results) {
        return leave(contextHolder.get(), node, results);
    }
     ...
     * @param node the node to be walked
     */
    public void arrive(BasicAuthentication node) {
        arrive(contextHolder.get(), node);
    }
     ...
     * @return the result of walking the node and it's children
     */
    public Object[] leave(BasicAuthentication node, Object[] results) {
        return leave(contextHolder.get(), node, results);
    }
     ...
     * @param node the node to be walked
     */
    public void arrive(TwoFactorAuthentication node) {
        arrive(contextHolder.get(), node);
    }
     ...
     * @return the result of walking the node and it's children
     */
    public Object[] leave(TwoFactorAuthentication node, Object[] results) {
        return leave(contextHolder.get(), node, results);
    }
