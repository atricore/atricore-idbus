...
public class SamlR2IdPProxyTransformer extends AbstractSPChannelTransformer implements InitializingBean {
    ...
    public void before(TransformEvent event) throws TransformException {
        ...
        createProxySpSide(event, serviceProvider, idpChannel, identityProvider, baseBeans, idpProxyBeans, signKs, encryptKs, idauPath);
    ...
    protected void createProxySpSide(TransformEvent event,
        ...
        // unitContainer
        setPropertyRef(spProxyBean, "unitContainer", provider.getIdentityAppliance().getName() + "-container");
        ...
        // State Manager
        setPropertyRef(spProxyBean, "stateManager", provider.getIdentityAppliance().getName() + "-state-manager");
        ...
        setConstructorArg(mBeanKey, 0, "java.lang.String", appliance.getNamespace() +  "." +
                ...
                ":type=ServiceProvider,name=" + applianceDef.getName() + "." + spProxyName);
        ...
        IdProjectResource<EntityDescriptorType> spMetadata = new IdProjectResource<EntityDescriptorType>(idGen.generateId(),
                ...
                generateIDPChannelMetadata(appliance, spProxyBean, provider, idpChannel, signKs, encryptKs, idauPath));
