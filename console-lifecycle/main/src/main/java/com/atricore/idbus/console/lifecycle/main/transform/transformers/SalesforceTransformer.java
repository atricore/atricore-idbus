...
public class SalesforceTransformer extends AbstractTransformer {

    private static final Log logger = LogFactory.getLog(SalesforceTransformer.class);

    @Override
    public boolean accept(TransformEvent event) {
        return event.getData() instanceof SalesforceServiceProvider;
    }

    @Override
    public void before(TransformEvent event) throws TransformException {

        SalesforceServiceProvider provider = (SalesforceServiceProvider) event.getData();
        ...
        if (logger.isDebugEnabled())
            logger.debug("Generating Salesforce " + provider.getName() + " configuration model");
        ...
        try {
            ed = MetadataUtil.createSalesforceDescriptor(provider);
