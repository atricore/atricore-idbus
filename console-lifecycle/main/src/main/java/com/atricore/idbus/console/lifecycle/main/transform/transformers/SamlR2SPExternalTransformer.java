 ...
 */
public class SamlR2SPExternalTransformer extends AbstractTransformer {

    private static final Log logger = LogFactory.getLog(SamlR2SPExternalTransformer.class);
