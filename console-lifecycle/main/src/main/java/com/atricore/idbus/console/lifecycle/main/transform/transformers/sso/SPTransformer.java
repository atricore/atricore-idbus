...
public class SPTransformer extends AbstractTransformer implements InitializingBean {
    ...
    public void before(TransformEvent event) throws TransformException {
        ...
        if (preferredIdp == null) {
            for (FederatedConnection fc : providerInternalSaml2.getFederatedConnectionsB()) {
        ...
        if (preferredIdp == null) {
            logger.warn("No preferred IDP could be found for SP " + providerInternalSaml2.getName());
        }
        ...
        descr.getContent().add(providerInternalSaml2.getName() + " : SP Configuration generated by Atricore Identity Bus Server on " + now.toGMTString());
        descr.getContent().add(providerInternalSaml2.getDescription());
        ...
        if (logger.isDebugEnabled())
            logger.debug("Generating SP " + providerInternalSaml2.getName() + " configuration model");
        ...
        // unitContainer
        setPropertyRef(sp, "unitContainer", providerInternalSaml2.getIdentityAppliance().getName() + "-container");
        ...
        // State Manager
        setPropertyRef(sp, "stateManager", providerInternalSaml2.getIdentityAppliance().getName() + "-state-manager");
        ...
        */
        ...
        if (providerInternalSaml2.getIdentityLookup() != null) {
