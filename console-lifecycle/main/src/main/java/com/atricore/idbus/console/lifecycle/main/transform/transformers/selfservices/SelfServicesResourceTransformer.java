 ...
 * @date: 2/28/13
 */
public class SelfServicesResourceTransformer extends AbstractTransformer {

    private static final Log logger = LogFactory.getLog(SelfServicesResourceTransformer.class);
    ...
    public void before(TransformEvent event) throws TransformException {
        ...
        String bcName = normalizeBeanName(sp.getName() + "-" + selfServicesResource.getName() + "-selfsvcs-rsrc");
