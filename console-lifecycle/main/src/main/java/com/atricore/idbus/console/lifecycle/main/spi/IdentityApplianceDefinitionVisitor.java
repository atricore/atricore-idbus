...
public interface IdentityApplianceDefinitionVisitor {
     ...
     * @param node the node to be walked
     */
    void arrive(ExternalWSFederationServiceProvider node) throws Exception;
     ...
     * @return the result of walking the node and it's children
     */
    Object[] leave(ExternalWSFederationServiceProvider node, Object[] results) throws Exception;
     ...
     * @return <code>false</code>, if no more childs should be walked, else <code>true</code>
     */
    boolean walkNextChild(ExternalWSFederationServiceProvider node, Object child, Object resultOfPreviousChild, int indexOfNextChild);
     ...
     * @param node the node to be walked
     */
    void arrive(DominoResource node) throws Exception;
     ...
     * @return the result of walking the node and it's children
     */
    Object[] leave(DominoResource node, Object[] results) throws Exception;
     ...
     * @return <code>false</code>, if no more childs should be walked, else <code>true</code>
     */
    boolean walkNextChild(DominoResource node, Object child, Object resultOfPreviousChild, int indexOfNextChild);
