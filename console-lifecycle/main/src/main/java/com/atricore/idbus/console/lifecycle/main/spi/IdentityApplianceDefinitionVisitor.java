...
public interface IdentityApplianceDefinitionVisitor {
     ...
     * @param node the node to be walked
     */
    void arrive(ExternalServiceProvider node) throws Exception;
     ...
     * @return the result of walking the node and it's children
     */
    Object[] leave(ExternalServiceProvider node, Object[] results) throws Exception;
     ...
     * @return <code>false</code>, if no more childs should be walked, else <code>true</code>
     */
    boolean walkNextChild(ExternalServiceProvider node, Object child, Object resultOfPreviousChild, int indexOfNextChild);
     ...
     * @param node the node to be walked
     */
    void arrive(ExternalIdentityProvider node) throws Exception;
     ...
     * @return the result of walking the node and it's children
     */
    Object[] leave(ExternalIdentityProvider node, Object[] results) throws Exception;
     ...
     * @return <code>false</code>, if no more childs should be walked, else <code>true</code>
     */
    boolean walkNextChild(ExternalIdentityProvider node, Object child, Object resultOfPreviousChild, int indexOfNextChild);
     ...
     * @param node the node to be walked
     */
    void arrive(BasicAuthentication node) throws Exception;
     ...
     * @return the result of walking the node and it's children
     */
    Object[] leave(BasicAuthentication node, Object[] results) throws Exception;
     ...
     * @return <code>false</code>, if no more childs should be walked, else <code>true</code>
     */
    boolean walkNextChild(BasicAuthentication node, Object child, Object resultOfPreviousChild, int indexOfNextChild);
     ...
     * @param node the node to be walked
     */
    void arrive(TwoFactorAuthentication node) throws Exception;
     ...
     * @return the result of walking the node and it's children
     */
    Object[] leave(TwoFactorAuthentication node, Object[] results) throws Exception;
     ...
     * @return <code>false</code>, if no more childs should be walked, else <code>true</code>
     */
    boolean walkNextChild(TwoFactorAuthentication node, Object child, Object resultOfPreviousChild, int indexOfNextChild);
}
