...
public interface Transformer {
    ...
    boolean accept(TransformEvent event);

    void before(TransformEvent event) throws TransformException;

    Object after(TransformEvent event) throws TransformException;
}
