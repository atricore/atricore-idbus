...
import org.atricore.idbus.capabilities.management.main.domain.metadata.ProviderRole;
    ...
    public void before(TransformEvent event) throws TransformException {
        ...
        if (cfg != null && cfg.getSigner() != null) {
            ...
            IdProjectResource<byte[]> signerResource = new IdProjectResource<byte[]>(idGen.generateId(),
                    baseSamlDestPath + idp.getName() + "/", signerResourceFileName,
            ...
            setPropertyValue(keyResolver, "keystoreFile", "classpath:" + baseSamlDestPath + idp.getName() + "/" + signerResourceFileName);
        ...
        if (cfg != null && cfg.getEncrypter() != null) {
            ...
            IdProjectResource<byte[]> encrypterResource = new IdProjectResource<byte[]>(idGen.generateId(),
                    baseSamlDestPath + idp.getName() + "/", encrypterResourceFileName,
                    "binary", cfg.getSigner().getStore().getValue());
            ...
            setPropertyValue(keyResolver, "keystoreFile", "classpath:" + baseSamlDestPath + idp.getName() + "/" + encrypterResourceFileName);
        ...
        setPropertyValue(idpMd, "resource", "classpath:" + baseSamlDestPath + idp.getName() + "/" + idp.getName() + "-samlr2-metadata.xml");
