    ...
    public Object[] getApplianceChildren(Object idApplianceElement) {
        try {
            ...
            for (Method method : ms) {
                ...
                if (type.getPackage() != null && type.getPackage().getName().equals("org.atricore.idbus.capabilities.management.main.domain.metadata") &&
                    ...
                    if (c != null) {
                        for (Object o : c) {
                            if (o.getClass().getPackage().getName().equals("org.atricore.idbus.capabilities.management.main.domain.metadata")
                                    && !o.getClass().isEnum()) {
                                children.add(o);
                            }
                        }
