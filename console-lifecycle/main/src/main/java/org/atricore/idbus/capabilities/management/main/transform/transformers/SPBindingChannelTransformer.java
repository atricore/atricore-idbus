...
import static org.atricore.idbus.capabilities.management.support.springmetadata.util.BeanUtils.newBean;
    ...
    public void before(TransformEvent event) throws TransformException {
        ...
        if (bindingChannel != null) {
            if (logger.isTraceEnabled())
                logger.trace("Generating Beans for Binding Channel " + bindingChannel.getName()  + " of SP " + provider.getName());
            ...
            Bean bc = newBean(spBeans, normalizeBeanName(bindingChannel.getName()),
