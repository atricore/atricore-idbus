...
public interface IProfileManagementService  extends IEventDispatcher {
    ...
    function updateUserProfile(updateUserProfileRequest:UpdateUserProfileRequest):AsyncToken;

    function updateUserPassword(updateUserPasswordRequest:UpdateUserPasswordRequest):AsyncToken;

    function fetchGroupMembership(fetchGroupMembershipRequest:FetchGroupMembershipRequest):AsyncToken;
