...
public class GenerateLicenseCommand  extends OsgiCommandSupport {
    ...
    @Option(name  = "--keyname", description = "Private key alias", required = true, multiValued = false)
    private String keyAlias;

    @Option(name = "--keypass", description = "Private key password", required = true, multiValued = false)
    private String keyPass;

    @Option(name = "--cert", description = "Certificate alias", required = true, multiValued = false)
