...
public class LicenseKeystoreKeyResolver extends LicenseKeyResolverImpl {

    private static final Log logger = LogFactory.getLog(LicenseKeystoreKeyResolver.class);
    ...
    public void init() throws LicenseKeyResolverException {
        InputStream is = null;
        try {
            ...
            throw new LicenseKeyResolverException("Error accessing or reading keystore", e);
        }

        if (privateKeyAlias != null && privateKey == null)
            throw new LicenseKeyResolverException("No private key found for : " + privateKeyAlias + " in " + keystoreFile);
        ...
        if (certificateAlias != null && certificate == null)
            throw new LicenseKeyResolverException("No certificate found for : " + certificateAlias + " in " + keystoreFile);
