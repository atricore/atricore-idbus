        ...
        <div id="authentication">
                ...
                <div id="subwrapper">
                    ...
                    <div class="main">
                        ...
                        <p><fmt:message key="claims.text.openIDLogin"/></p>
                        <form:form method="post" commandName="collectOpenID" >
                            <fieldset>
                                <div><label for="openid"><fmt:message key="claims.label.openid"/> </label> <form:input cssClass="text" path="openid" tabindex="10"/>
                                </div>
