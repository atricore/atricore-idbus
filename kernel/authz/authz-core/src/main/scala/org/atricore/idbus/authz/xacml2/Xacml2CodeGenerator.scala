...
package org.atricore.idbus.authz.xacml2

import org.atricore.idbus.authz.{PolicySource, AuthorizationEngine}
import xml.Node
import org.atricore.idbus.authz.support.{Code, CodeGenerator}
...
class Xacml2CodeGenerator extends CodeGenerator {
  ...
  def acTemplate(acFileName: String, policies: String) ="""import org.atricore.idbus.authz._
import dsl._
