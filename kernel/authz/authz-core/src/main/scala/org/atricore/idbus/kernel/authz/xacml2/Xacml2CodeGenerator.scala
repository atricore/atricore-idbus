...
package org.atricore.idbus.kernel.authz.xacml2

import org.atricore.idbus.kernel.authz.{PolicySource, AuthorizationEngine}
import xml.Node
import org.atricore.idbus.kernel.authz.support.{Code, CodeGenerator}
...
class Xacml2CodeGenerator extends CodeGenerator {
  ...
  def acTemplate(acFileName: String, policies: String) ="""import org.atricore.idbus.kernel.authz._
import dsl._
