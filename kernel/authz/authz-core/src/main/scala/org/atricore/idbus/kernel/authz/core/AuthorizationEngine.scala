    ...
    val cl = if (from_cache) {
      ...
      new URLClassLoader(
        Array(
          ...
          //new File(System.getProperty("karaf.home") + "/system/org/atricore/idbus/kernel/authz/org.atricore.idbus.kernel.authz.core/1.4.1/org.atricore.idbus.kernel.authz.core-1.4.1.jar").toURI.toURL
