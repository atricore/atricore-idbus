...
class AuthorizationConfigurationImpl extends AuthorizationConfiguration {
  ...
  private def precompilePolicies {
    ...
    precompiler.classpath = System.getProperty("karaf.home") +
      ...
      System.getProperty("karaf.home") + "/system/org/atricore/idbus/kernel/authz/org.atricore.idbus.kernel.authz.core/1.4.3/org.atricore.idbus.kernel.authz.core-1.4.3.jar"
