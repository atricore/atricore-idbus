...
class AuthorizationConfigurationImpl extends AuthorizationConfiguration {
  ...
  private def precompilePolicies {
    ...
    precompiler.classpath = System.getProperty("karaf.home") +
      ...
      System.getProperty("karaf.home") + "/system/org/atricore/idbus/kernel/authz/org.atricore.idbus.kernel.authz.core/1.6.2-SNAPSHOT/org.atricore.idbus.kernel.authz.core-1.6.2-SNAPSHOT.jar"
