...
/**
 * Provider representation for identity confirmation.
 *
 * @author <a href="mailto:gbrigandi@atricore.org">Gianluca Brigandi</a>
 */
public interface IdentityConfirmationProvider extends Provider, StatefulProvider {

    IdentityConfirmationChannel getChannel();
