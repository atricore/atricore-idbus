 ...
 * @version $Id: BaseSessionImpl.java 1359 2009-07-19 16:57:57Z sgonzalez $
 */
...
public class BaseSessionImpl implements BaseSession {
    ...
    // Last node where this session was managed
    ...
    public void fireSessionEvent(String type, Object data) {
        SSOSessionEventManager.getInstance().fireSessionEvent(type, this, data);
    }
    ...
    /**
     * Getter for the security token associated with the session.
     */
    ...
    /**
     * Setter for the security token associated with the session.
     *
     * @param securityToken
     */
    ...
    /**
     * Sets the last node where this session was handled.
     * @param node
     */
