...
public class AccessController {
     ...
     * @see #doPrivileged(java.security.PrivilegedAction, java.security.AccessControlContext)
     * @see #doPrivileged(java.security.PrivilegedExceptionAction)
     */
     ...
     * @return the value returned by the action's <code>run</code> method.
     * @see #doPrivileged(java.security.PrivilegedAction)
     * @see #doPrivileged(java.security.PrivilegedExceptionAction, java.security.AccessControlContext)
     */
     ...
     *                privileges before performing the specified action.
     * @return the value returned by the action's <code>run</code> method.
     * @throws java.security.PrivilegedActionException the specified action's
     ...
     * @throws java.security.AccessControlException if the specified permission
