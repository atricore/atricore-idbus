 ...
 */
public interface IdentityMediationUnitRegistry {
    
    Collection<IdentityMediationUnit> getIdentityMediationUnits();

    void register(String idmuName, IdentityMediationUnit idmu);
