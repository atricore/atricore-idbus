...
public class RememberMeAuthScheme extends AbstractAuthenticationScheme {
    ...
    public String getUsernameForToken(String remembermeToken) {
        ...
        try {
            String msg = CipherUtil.decryptAES(remembermeToken, base64Key);
    ...
    public String getRemembermeTokenForUser(String username) {
        try {
            return CipherUtil.encryptAES("josso:" + username, base64Key);
        } catch (UnsupportedEncodingException e) {
     ...
     * @see #getRememberMeCredential(org.atricore.idbus.kernel.main.authn.Credential[])
     */
