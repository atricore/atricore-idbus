 ...
 */
public class ProcessDescriptorLifecycleListener {
    ...
    public void onBind(ProcessDescriptor processDescriptor, Map properties) throws Exception {
        processDescriptor.setProcessFragmentRegistry(processFragmentRegistry);
    }

    public void onUnbind(ProcessDescriptor processDescriptor, Map properties) throws Exception {
        processDescriptor.setProcessFragmentRegistry(null);
    }
