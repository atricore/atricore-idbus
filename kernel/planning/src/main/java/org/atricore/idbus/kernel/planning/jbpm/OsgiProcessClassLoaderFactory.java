 ...
 */
public class OsgiProcessClassLoaderFactory implements ProcessClassLoaderFactory, Serializable {

  private static final long serialVersionUID = 1L;

  public ClassLoader getProcessClassLoader(ProcessDefinition processDefinition) {
    return new OsgiProcessClassLoader(ClassLoaderUtil.getClassLoader(), processDefinition);
  }
}