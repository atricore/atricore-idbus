...
import org.mortbay.jetty.servlet.wadi.*;
 ...
 * @version $Id$
 */
public class OsgiWadiSessionManager extends AbstractSessionManager
{
     ...
     */
    public OsgiWadiSessionManager(ClassLoader cl, WadiCluster wadiCluster,
            int nbReplica,
            int numPartitions,
            int sweepInterval,
    ...
    public void doStart() throws Exception
    {
        ...
        if (_deltaReplication) {
            stackContext = new AOPStackContext(_classLoader != null ? _classLoader : Thread.currentThread().getContextClassLoader(),
                serviceSpaceName,
            ...
            stackContext = new StackContext(_classLoader != null ? _classLoader : Thread.currentThread().getContextClassLoader(),
                serviceSpaceName,
                _wadiCluster.getDispatcher(),
                _dftMaxIdleSecs,
                _numPartitions,
