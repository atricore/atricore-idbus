...
Scenario: Successfull upgrade JOSSO EE Distribution license
...
Scenario: Unsuccessfull upgrade JOSSO EE Distribution license
   Given I am on the settings screen of EE product
   And I am seeing the 'Activate JOSSO EE' form
   When I upload the new license file
   And I confirm the Activation process
   Then I should be able to see an error report regarding the provided License